...
/**
 * Calculate bowling score from frames
 * @param frames Array of bowling frames
 * @returns Object containing total score and frame scores
 */
 ...
 */
function getStrikeBonus(frames: Frame[], frameIndex: number): number {
 ...
 */
function getSpareBonus(frames: Frame[], frameIndex: number): number {
 ...
 * @param frames Array of bowling frames
 * @param currentTotalScore Current total score
