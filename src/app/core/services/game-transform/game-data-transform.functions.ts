...
import { calculateIsClean } from '../game-utils/game-utils.functions';

/**
 * Transforms raw game data into a normalized Game object
 */
export function transformGameData(
  ...
  try {
    ...
    const isClean = calculateIsClean(frames);
